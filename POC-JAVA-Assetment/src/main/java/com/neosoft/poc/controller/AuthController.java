...
import com.neosoft.poc.exception.APIException;
import com.neosoft.poc.payloads.ApiResponse;
import com.neosoft.poc.payloads.JwtAuthRequest;
import com.neosoft.poc.payloads.JwtAuthResponse;
...
public class AuthController {
	...
	public ResponseEntity<UserDto> getUser(Principal principal) {
		User user = this.userRepo.findByEmailId(principal.getName()).get();
